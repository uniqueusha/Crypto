...
router.get('/all-set-target', saleTargetHeaderController.getAllSetTargets);
...
router.get('/all-reached', saleTargetHeaderController.getAllSetTargetReached);
router.get('/reached', checkAuth, saleTargetHeaderController.getSetTargetReached);
router.get('/all-sold-coin', saleTargetHeaderController.getAllSoldCoin);
